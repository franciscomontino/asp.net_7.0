...
namespace app.Migrations
{
    ...
    [Migration("20231117103010_Users")]
    partial class Users
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Product_API.Models.KindOfProduct", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            KindOfProductId = 1,
                            Create = new DateTime(2023, 11, 17, 23, 30, 10, 401, DateTimeKind.Local).AddTicks(5058),
                            Detail = "Laptops",
                            Name = "Laptop",
                            Update = new DateTime(2023, 11, 17, 23, 30, 10, 401, DateTimeKind.Local).AddTicks(5108)
                        });
                });
            ...
            modelBuilder.Entity("Product_API.Models.UserApplication", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Product_API.Models.UserApplication", null)
                        .WithMany()
